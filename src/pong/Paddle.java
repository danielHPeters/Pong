...
public class Paddle extends Rectangle {
    ...
    /**
     * Check for keys pressed and move
     * (Workaround for input lag)
     * 
     * @param panelHeight Height of the Panel to see if out of bounds
     *        when moving down
     */
    ...
    /**
     * Moves the Paddle up by speed of itself
     * checks if the Paddle is out of bounds
     */
    public void moveUp() {
        if (this.y > 0) {
            this.y -= speed;
    ...
    /**
     * Moves the Paddle down by speed of itself
     * checks if the Paddle is out of bounds
     * 
     * @param panelHeight 
     */
